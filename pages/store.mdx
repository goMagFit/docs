...
To access your store, users can search your gym name and click on your page. Once on your page, users need to click the `Gym Store` floating button. By clicking the `Gym Store` button the user will be navigated to your store.
...
## Successful Payments
There are two ways that you can check successful payments within your [MoreGyms Dashboard](https://dashboard.moregyms.com/store#payments):
