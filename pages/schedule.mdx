...
To remove a single class you need to click the red `Remove` button. After you click the `Remove` button, the class will not show up just for that specific date.
